...
namespace GPUInstancer
{
    public abstract class GPUInstancerManager : MonoBehaviour
    {
        ...
        public virtual void Awake()
        {
            ...
            if (SystemInfo.supportsComputeShaders)
            {
                if (_visibilityComputeShader == null)
                {
                    ...
                    {
                        GPUInstancerConstants.VISIBILITY_SHADER_THREAD_COUNT = 512;
                    }
#endif
        ...
        public void SetupOcclusionCulling(GPUInstancerCameraData renderingCameraData)
        {
            ...
            if (isOcclusionCulling && !GPUInstancerConstants.gpuiSettings.isHDRP && !GPUInstancerConstants.gpuiSettings.isLWRP)
            {
