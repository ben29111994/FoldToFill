...
namespace GPUInstancer
{
    ...
    public static class GPUInstancerConstants
    {
        ...
        public static float VISIBILITY_SHADER_THREAD_COUNT = 512;
        ...
        public static float VISIBILITY_SHADER_THREAD_COUNT = 128;
...
#else
        public static float VISIBILITY_SHADER_THREAD_COUNT = 1024;
#endif
...
#if !UNITY_EDITOR && (UNITY_IOS || UNITY_TVOS)
        public static readonly Vector3 GRASS_SHADER_THREAD_COUNT = new Vector3(16, 1, 16);
#elif !UNITY_EDITOR && UNITY_ANDROID
        public static readonly Vector3 GRASS_SHADER_THREAD_COUNT = new Vector3(8, 1, 8);
#else
